...
class MemCache extends CacheFather
{
    ...
    function __construct($save_path, array $option = array())
    {
        if (!extension_loaded('memcached')) {
            throw new CacheException(Language::get('cache.extension_load_failed', 'php_memcached'));
        }
        ...
        if (!$this->_container->getVersion()) {
            throw new CacheException(Language::get('cache.cacher_create_failed', 'Memcached'));
        }
    }

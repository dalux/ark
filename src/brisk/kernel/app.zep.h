...
ZEND_BEGIN_ARG_INFO_EX(arginfo_brisk_kernel_app_setapp, 0, 0, 1)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_brisk_kernel_app_getapp, 0, 0, 0)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_brisk_kernel_app_addlanguagepackage, 0, 0, 2)
...
ZEND_BEGIN_ARG_INFO_EX(arginfo_brisk_kernel_app_addeventlistener, 0, 0, 2)
...
ZEPHIR_INIT_FUNCS(brisk_kernel_app_method_entry) {
	PHP_ME(Brisk_Kernel_App, setApp, arginfo_brisk_kernel_app_setapp, ZEND_ACC_PUBLIC)
	PHP_ME(Brisk_Kernel_App, setConfig, arginfo_brisk_kernel_app_setconfig, ZEND_ACC_PUBLIC)
	PHP_ME(Brisk_Kernel_App, setControllerDir, arginfo_brisk_kernel_app_setcontrollerdir, ZEND_ACC_PUBLIC)
	PHP_ME(Brisk_Kernel_App, getApp, arginfo_brisk_kernel_app_getapp, ZEND_ACC_PUBLIC)
	PHP_ME(Brisk_Kernel_App, getControllerDir, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Brisk_Kernel_App, addLanguagePackage, arginfo_brisk_kernel_app_addlanguagepackage, ZEND_ACC_PUBLIC)
	PHP_ME(Brisk_Kernel_App, setLanguage, arginfo_brisk_kernel_app_setlanguage, ZEND_ACC_PUBLIC)
	PHP_ME(Brisk_Kernel_App, addEventListener, arginfo_brisk_kernel_app_addeventlistener, ZEND_ACC_PUBLIC)

...
PHP_METHOD(Brisk_Kernel_Handler, setHandler) {
	...
	if (ZEPHIR_IS_STRING(&type, "exception")) {
		ZEPHIR_CALL_FUNCTION(NULL, "restore_exception_handler", NULL, 31);
		...
		ZEPHIR_CALL_FUNCTION(NULL, "set_exception_handler", NULL, 32, handler);
		zephir_check_call_status();
	}
	ZEPHIR_MM_RESTORE();
		...
		if (ZEPHIR_LE(&_3$$3, &_4$$3)) {
			while (1) {
				...
				if (ZEPHIR_IS_LONG(&i$$3, ((zephir_get_numberval(&line$$3) - 1)))) {
					...
					zephir_check_call_status();
					ZEPHIR_CALL_FUNCTION(&_13$$5, "htmlspecialchars", &_14, 36, &_11$$5);
					zephir_check_call_status();
					...
					zephir_check_call_status();
					ZEPHIR_CALL_FUNCTION(&_23$$6, "htmlspecialchars", &_14, 36, &_22$$6);
					zephir_check_call_status();
...
PHP_METHOD(Brisk_Kernel_Handler, display) {
	...
	ZEPHIR_CALL_FUNCTION(&included, "get_included_files", NULL, 37);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&footerinfo, "strftime", NULL, 38, &_14, &_13);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_VAR(&_18);
	ZEPHIR_CONCAT_VSSSS(&_18, &footerinfo, " Provider by ", "Brisk", " ", "1.0.3");
	...
	ZEPHIR_CALL_FUNCTION(NULL, "usort", NULL, 39, &namespaces, &_21);
	...
	if (!zephir_is_true(&_26)) {
		...
		array_init(&trace$$6);
		zephir_is_iterable(&trace_array$$6, 0, "brisk/Kernel/Handler.zep", 86);
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&trace_array$$6), _30$$6, _31$$6, _29$$6)
		{
			...
			zephir_array_append(&trace$$6, &_32$$7, PH_SEPARATE, "brisk/Kernel/Handler.zep", 84);
		} ZEND_HASH_FOREACH_END();
		ZEPHIR_INIT_NVAR(&v$$6);
		ZEPHIR_INIT_NVAR(&k$$6);
		...
		zephir_array_append(&trace$$6, &_34$$6, PH_SEPARATE, "brisk/Kernel/Handler.zep", 86);
		...
		zephir_is_iterable(&trace$$6, 0, "brisk/Kernel/Handler.zep", 97);
		ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&trace$$6), _36$$6, _37$$6, _35$$6)
		{
			...
			ZEPHIR_INIT_NVAR(&v$$6);
			ZVAL_COPY(&v$$6, _35$$6);
			zephir_array_fetch_string(&_39$$8, &v$$6, SL("description"), PH_NOISY | PH_READONLY, "brisk/Kernel/Handler.zep", 91 TSRMLS_CC);
			...
			zephir_array_fetch_string(&_41$$8, &v$$6, SL("description"), PH_NOISY | PH_READONLY, "brisk/Kernel/Handler.zep", 92 TSRMLS_CC);
			...
			zephir_array_fetch_string(&_48$$8, &v$$6, SL("description"), PH_NOISY | PH_READONLY, "brisk/Kernel/Handler.zep", 93 TSRMLS_CC);
		...
		ZEPHIR_INIT_NVAR(&v$$6);
		ZEPHIR_INIT_NVAR(&k$$6);
		ZEPHIR_CALL_METHOD(&tplcontent$$6, this_ptr, "_getwebtpl", NULL, 40);
		zephir_check_call_status();
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(&tplcontent$$11, this_ptr, "_getclitpl", NULL, 41);
		zephir_check_call_status();

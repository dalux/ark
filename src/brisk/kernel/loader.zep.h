...
ZEND_BEGIN_ARG_INFO_EX(arginfo_brisk_kernel_loader_addautoloader, 0, 0, 1)
...
ZEPHIR_INIT_FUNCS(brisk_kernel_loader_method_entry) {
	...
	PHP_ME(Brisk_Kernel_Loader, addAutoLoader, arginfo_brisk_kernel_loader_addautoloader, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)

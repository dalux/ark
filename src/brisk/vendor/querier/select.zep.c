...
ZEPHIR_INIT_CLASS(Brisk_Vendor_Querier_Select) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Brisk\\Vendor\\Querier, Select, brisk, vendor_querier_select, brisk_vendor_querier_querierfather_ce, brisk_vendor_querier_select_method_entry, ZEND_ACC_EXPLICIT_ABSTRACT_CLASS);
...
PHP_METHOD(Brisk_Vendor_Querier_Select, group) {
	...
	ZEPHIR_INIT_VAR(_0);
	zephir_is_iterable(columns, &_2, &_1, 0, 0, "brisk/Vendor/Querier/Select.zep", 46);
	for (
...
PHP_METHOD(Brisk_Vendor_Querier_Select, pickSelectPart) {
	...
	zephir_array_fetch_string(&from_part, _0, SL("from"), PH_NOISY, "brisk/Vendor/Querier/Select.zep", 167 TSRMLS_CC);
	if (zephir_fast_count_int(from_part TSRMLS_CC) > 0) {
		ZEPHIR_INIT_VAR(_1$$3);
		zephir_is_iterable(from_part, &_3$$3, &_2$$3, 0, 0, "brisk/Vendor/Querier/Select.zep", 214);
		for (
		  ...
		  ; zend_hash_move_forward_ex(_3$$3, &_2$$3)
			...
			zephir_array_fetch_long(&_5$$4, val, 0, PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 174 TSRMLS_CC);
			ZEPHIR_MAKE_REF(_5$$4);
			ZEPHIR_CALL_FUNCTION(&from_table$$3, "each", &_6, 5, _5$$4);
			ZEPHIR_UNREF(_5$$4);
			zephir_check_call_status();
			ZEPHIR_OBS_NVAR(k);
			zephir_array_fetch_string(&k, from_table$$3, SL("key"), PH_NOISY, "brisk/Vendor/Querier/Select.zep", 175 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(v);
			zephir_array_fetch_string(&v, from_table$$3, SL("value"), PH_NOISY, "brisk/Vendor/Querier/Select.zep", 176 TSRMLS_CC);
			ZEPHIR_CALL_FUNCTION(&_7$$4, "is_integer", &_8, 6, k);
			zephir_check_call_status();
			if (zephir_is_true(_7$$4)) {
				ZEPHIR_INIT_NVAR(alias$$3);
				ZVAL_STRING(alias$$3, "", 1);
				zephir_array_append(&table, v, PH_SEPARATE, "brisk/Vendor/Querier/Select.zep", 180);
			} else {
				ZEPHIR_CPY_WRT(alias$$3, k);
				ZEPHIR_INIT_LNVAR(_9$$6);
				ZEPHIR_CONCAT_VSV(_9$$6, v, " ", alias$$3);
				zephir_array_append(&table, _9$$6, PH_SEPARATE, "brisk/Vendor/Querier/Select.zep", 183);
			}
			zephir_array_fetch_long(&_10$$4, val, 1, PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 186 TSRMLS_CC);
			zephir_is_iterable(_10$$4, &_12$$4, &_11$$4, 0, 0, "brisk/Vendor/Querier/Select.zep", 213);
			for (
			  ...
			  ; zend_hash_move_forward_ex(_12$$4, &_11$$4)
				...
				if (zephir_is_true(_14$$7)) {
					...
					ZEPHIR_CALL_FUNCTION(&_21$$8, "is_integer", &_8, 6, k);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_FUNCTION(&_23$$11, "is_integer", &_8, 6, k);
					zephir_check_call_status();
				...
				zephir_array_fetch_long(&_27$$7, val, 1, PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 211 TSRMLS_CC);
				zephir_array_fetch(&_28$$7, _27$$7, k, PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 211 TSRMLS_CC);
				zephir_array_append(&fields, _28$$7, PH_SEPARATE, "brisk/Vendor/Querier/Select.zep", 211);
			}
		}
		_29$$3 = zephir_fetch_nproperty_this(this_ptr, SL("_parts"), PH_NOISY_CC);
		ZEPHIR_OBS_VAR(join_part$$3);
		zephir_array_fetch_string(&join_part$$3, _29$$3, SL("join"), PH_NOISY, "brisk/Vendor/Querier/Select.zep", 215 TSRMLS_CC);
		if (zephir_fast_count_int(join_part$$3 TSRMLS_CC) > 0) {
			ZEPHIR_INIT_VAR(_30$$18);
			zephir_is_iterable(join_part$$3, &_32$$18, &_31$$18, 0, 0, "brisk/Vendor/Querier/Select.zep", 272);
			for (
			  ...
			  ; zend_hash_move_forward_ex(_32$$18, &_31$$18)
				...
				zephir_array_fetch_long(&join_flag$$18, val, 0, PH_NOISY, "brisk/Vendor/Querier/Select.zep", 220 TSRMLS_CC);
				ZEPHIR_OBS_NVAR(join_table$$18);
				zephir_array_fetch_long(&join_table$$18, val, 1, PH_NOISY, "brisk/Vendor/Querier/Select.zep", 221 TSRMLS_CC);
				ZEPHIR_OBS_NVAR(join_cond$$18);
				zephir_array_fetch_long(&join_cond$$18, val, 2, PH_NOISY, "brisk/Vendor/Querier/Select.zep", 222 TSRMLS_CC);
				ZEPHIR_OBS_NVAR(join_fields$$18);
				zephir_array_fetch_long(&join_fields$$18, val, 3, PH_NOISY, "brisk/Vendor/Querier/Select.zep", 223 TSRMLS_CC);
				...
				if (zephir_fast_in_array(join_flag$$18, _34$$19 TSRMLS_CC)) {
					...
					ZEPHIR_CALL_FUNCTION(&_36$$20, "each", &_6, 5, join_table$$18);
					ZEPHIR_UNREF(join_table$$18);
					zephir_check_call_status();
					ZEPHIR_CPY_WRT(join_table$$18, _36$$20);
					ZEPHIR_OBS_NVAR(k);
					zephir_array_fetch_long(&k, join_table$$18, 0, PH_NOISY, "brisk/Vendor/Querier/Select.zep", 232 TSRMLS_CC);
					ZEPHIR_OBS_NVAR(v);
					zephir_array_fetch_long(&v, join_table$$18, 1, PH_NOISY, "brisk/Vendor/Querier/Select.zep", 233 TSRMLS_CC);
					ZEPHIR_CALL_FUNCTION(&_36$$20, "is_integer", &_8, 6, k);
					zephir_check_call_status();
					if (zephir_is_true(_36$$20)) {
						ZEPHIR_INIT_NVAR(alias$$3);
						ZVAL_STRING(alias$$3, "", 1);
						zephir_array_fetch(&_37$$21, keys$$18, join_flag$$18, PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 237 TSRMLS_CC);
						ZEPHIR_INIT_LNVAR(_38$$21);
						ZEPHIR_CONCAT_VSVSVS(_38$$21, _37$$21, " ", v, " ON ", join_cond$$18, " ");
						zephir_array_append(&join, _38$$21, PH_SEPARATE, "brisk/Vendor/Querier/Select.zep", 237);
					} else {
						ZEPHIR_CPY_WRT(alias$$3, k);
						zephir_array_fetch(&_39$$22, keys$$18, join_flag$$18, PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 240 TSRMLS_CC);
						ZEPHIR_INIT_LNVAR(_40$$22);
						ZEPHIR_CONCAT_VSVSVSVS(_40$$22, _39$$22, " ", v, " ", alias$$3, " ON ", join_cond$$18, " ");
						zephir_array_append(&join, _40$$22, PH_SEPARATE, "brisk/Vendor/Querier/Select.zep", 240);
					}
					zephir_is_iterable(join_fields$$18, &_42$$20, &_41$$20, 0, 0, "brisk/Vendor/Querier/Select.zep", 270);
					for (
					  ...
					  ; zend_hash_move_forward_ex(_42$$20, &_41$$20)
						...
						if (zephir_is_true(_44$$23)) {
							...
							ZEPHIR_CALL_FUNCTION(&_51$$24, "is_integer", &_8, 6, k);
							zephir_check_call_status();
							...
							ZEPHIR_CALL_FUNCTION(&_53$$27, "is_integer", &_8, 6, k);
							zephir_check_call_status();
						...
						zephir_array_fetch(&_57$$23, join_fields$$18, k, PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 268 TSRMLS_CC);
						zephir_array_append(&fields, _57$$23, PH_SEPARATE, "brisk/Vendor/Querier/Select.zep", 268);
					}
				}
			}
		}
...
PHP_METHOD(Brisk_Vendor_Querier_Select, pickGroupPart) {
	...
	zephir_array_fetch_string(&group_part, _0, SL("group"), PH_NOISY, "brisk/Vendor/Querier/Select.zep", 294 TSRMLS_CC);
	if (zephir_fast_count_int(group_part TSRMLS_CC) > 0) {
		ZEPHIR_INIT_VAR(_1$$3);
		zephir_is_iterable(group_part, &_3$$3, &_2$$3, 0, 0, "brisk/Vendor/Querier/Select.zep", 299);
		for (
		  ; zend_hash_get_current_data_ex(_3$$3, (void**) &_4$$3, &_2$$3) == SUCCESS
		  ; zend_hash_move_forward_ex(_3$$3, &_2$$3)
		) {
			ZEPHIR_GET_HMKEY(_1$$3, _3$$3, _2$$3);
			ZEPHIR_GET_HVALUE(val, _4$$3);
			zephir_array_append(&group, val, PH_SEPARATE, "brisk/Vendor/Querier/Select.zep", 297);
		}
	}
...
PHP_METHOD(Brisk_Vendor_Querier_Select, pickHavingPart) {
	...
	zephir_array_fetch_string(&having_part, _0, SL("having"), PH_NOISY, "brisk/Vendor/Querier/Select.zep", 313 TSRMLS_CC);
	if (zephir_fast_count_int(having_part TSRMLS_CC) > 0) {
		zephir_is_iterable(having_part, &_2$$3, &_1$$3, 0, 0, "brisk/Vendor/Querier/Select.zep", 332);
		for (
		  ...
		  ; zend_hash_move_forward_ex(_2$$3, &_1$$3)
			...
			zephir_array_fetch_string(&cond, val, SL("cond"), PH_NOISY, "brisk/Vendor/Querier/Select.zep", 317 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(value);
			zephir_array_fetch_string(&value, val, SL("val"), PH_NOISY, "brisk/Vendor/Querier/Select.zep", 318 TSRMLS_CC);
			if (Z_TYPE_P(value) == IS_NULL) {
				ZEPHIR_CPY_WRT(part, cond);
				if (zephir_instance_of_ev(cond, brisk_vendor_querier_select_ce TSRMLS_CC)) {
			...
			zephir_array_fetch_long(&_9$$4, having_part, (zephir_get_numberval(key) + 1), PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 327 TSRMLS_CC);
			if (!(Z_TYPE_P(_9$$4) == IS_NULL)) {
				ZEPHIR_INIT_LNVAR(_10$$8);
				ZEPHIR_CONCAT_VS(_10$$8, part, " AND ");
				ZEPHIR_CPY_WRT(part, _10$$8);
			}
			zephir_array_append(&having, part, PH_SEPARATE, "brisk/Vendor/Querier/Select.zep", 330);
		}
	}
	ZEPHIR_INIT_VAR(_11);
...
PHP_METHOD(Brisk_Vendor_Querier_Select, pickOrderPart) {
	...
	zephir_array_fetch_string(&order_part, _0, SL("order"), PH_NOISY, "brisk/Vendor/Querier/Select.zep", 345 TSRMLS_CC);
	if (zephir_fast_count_int(order_part TSRMLS_CC) > 0) {
		ZEPHIR_INIT_VAR(_1$$3);
		zephir_is_iterable(order_part, &_3$$3, &_2$$3, 0, 0, "brisk/Vendor/Querier/Select.zep", 355);
		for (
		  ; zend_hash_get_current_data_ex(_3$$3, (void**) &_4$$3, &_2$$3) == SUCCESS
		  ; zend_hash_move_forward_ex(_3$$3, &_2$$3)
		) {
			...
			zephir_array_fetch_long(&_5$$4, v, 1, PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 348 TSRMLS_CC);
			if (Z_TYPE_P(_5$$4) == IS_NULL) {
				zephir_array_fetch_long(&_6$$5, v, 0, PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 349 TSRMLS_CC);
				zephir_array_append(&order, _6$$5, PH_SEPARATE, "brisk/Vendor/Querier/Select.zep", 349);
			} else {
				ZEPHIR_OBS_NVAR(_7$$6);
				zephir_array_fetch_long(&_7$$6, v, 1, PH_NOISY, "brisk/Vendor/Querier/Select.zep", 351 TSRMLS_CC);
				by = zephir_get_boolval(_7$$6);
				zephir_array_fetch_long(&_8$$6, v, 0, PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 352 TSRMLS_CC);
				ZEPHIR_INIT_LNVAR(_9$$6);
				if (by) {
				...
				zephir_array_append(&order, _10$$6, PH_SEPARATE, "brisk/Vendor/Querier/Select.zep", 352);
			}
		}
	}
	ZEPHIR_INIT_VAR(_11);
...
PHP_METHOD(Brisk_Vendor_Querier_Select, pickLimitPart) {
	...
	ZVAL_STRING(limit, "", 1);
	_0 = zephir_fetch_nproperty_this(this_ptr, SL("_parts"), PH_NOISY_CC);
	zephir_array_fetch_string(&limit_part, _0, SL("limit"), PH_NOISY | PH_READONLY, "brisk/Vendor/Querier/Select.zep", 368 TSRMLS_CC);
	if (!ZEPHIR_IS_STRING(limit_part, "")) {
		...
		zephir_array_fetch_string(&offset_part$$3, _1$$3, SL("offset"), PH_NOISY, "brisk/Vendor/Querier/Select.zep", 371 TSRMLS_CC);
...
PHP_METHOD(Brisk_Vendor_Querier_Select, getSQL) {
	...
	zval *select = NULL, *where$$3 = NULL, *group$$3 = NULL, *having$$3 = NULL, *order$$3 = NULL, *limit$$3 = NULL, *_0$$4, *_1$$5, *_2$$6, *_3$$7, *_4$$8;
	zend_long ZEPHIR_LAST_CALL_STATUS;

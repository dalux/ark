...
PHP_METHOD(Brisk_Vendor_Cache_CacheAdapter, getDriver) {
	...
	zval *driver_param = NULL, *save_path_param = NULL, *option_param = NULL, *_1 = NULL, *instance = NULL, *_8 = NULL, _16, _17, *_18 = NULL, *_19, *_3$$3, *_4$$3 = NULL, *_7$$3, *_10$$4, *_11$$4 = NULL, *_13$$4 = NULL;
	...
	if (_0) {
		...
		ZVAL_STRING(_7$$3, "cache.driver_not_found", ZEPHIR_TEMP_PARAM_COPY);
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_3$$3, "brisk/Vendor/Cache/CacheAdapter.zep", 25 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (!((zephir_instance_of_ev(instance, brisk_vendor_cache_cachefather_ce TSRMLS_CC)))) {
		...
		ZVAL_STRING(_13$$4, "\\Brisk\\Vendor\\Cache\\CacheFather", 1);
		zephir_array_fast_append(_12$$4, _13$$4);
		ZEPHIR_INIT_NVAR(_13$$4);
		ZVAL_STRING(_13$$4, "cache.driver_implement_error", ZEPHIR_TEMP_PARAM_COPY);
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_10$$4, "brisk/Vendor/Cache/CacheAdapter.zep", 30 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(_15);
	...
	zephir_check_call_status();
	zephir_array_update_string(&_15, SL("cache"), &_18, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_VAR(_19);
...
PHP_METHOD(Brisk_Vendor_Cache_CacheAdapter, getDriverFromConfig) {
	...
	if (!zephir_is_true(_4)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_13$$3, "brisk/Vendor/Cache/CacheAdapter.zep", 47 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_18$$4, "brisk/Vendor/Cache/CacheAdapter.zep", 49 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_23$$5, "brisk/Vendor/Cache/CacheAdapter.zep", 51 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	ZEPHIR_OBS_VAR(_30);
	zephir_read_property(&_30, _29, SL("cache"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(_31);
	...
	ZEPHIR_OBS_VAR(_35);
	zephir_read_property(&_35, _34, SL("cache"), PH_NOISY_CC);
	ZEPHIR_OBS_VAR(_36);
	...
	if (_38) {
		...
		ZVAL_STRING(_44$$6, "cache.driver_not_found", ZEPHIR_TEMP_PARAM_COPY);
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_41$$6, "brisk/Vendor/Cache/CacheAdapter.zep", 56 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(instance);
	...
	if (zephir_has_constructor(instance TSRMLS_CC)) {
		zephir_array_fetch_string(&_47, options, SL("save_path"), PH_NOISY | PH_READONLY, "brisk/Vendor/Cache/CacheAdapter.zep", 59 TSRMLS_CC);
		zephir_array_fetch_string(&_48, options, SL("option"), PH_NOISY | PH_READONLY, "brisk/Vendor/Cache/CacheAdapter.zep", 59 TSRMLS_CC);
	...
	if (!((zephir_instance_of_ev(instance, brisk_vendor_cache_cachefather_ce TSRMLS_CC)))) {
		...
		ZVAL_STRING(_52$$7, "\\Brisk\\Vendor\\Cache\\CacheFather", 1);
		zephir_array_fast_append(_51$$7, _52$$7);
		ZEPHIR_INIT_NVAR(_52$$7);
		ZVAL_STRING(_52$$7, "cache.driver_implement_error", ZEPHIR_TEMP_PARAM_COPY);
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_49$$7, "brisk/Vendor/Cache/CacheAdapter.zep", 61 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(_54);
	...
	zephir_check_call_status();
	zephir_array_update_string(&_54, SL("cache"), &_56, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_VAR(_57);

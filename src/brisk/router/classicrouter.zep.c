...
PHP_METHOD(Brisk_Router_ClassicRouter, ready) {
	...
	zend_bool _28;
	zval _10, _34$$4;
	zval __$false, uri, result, params, _1, _2, _3, _4, path_now, ns_part, ns_space, _6, _8, _9, _11, _12, _13, _14, _16, _21, _22, _24, _27, _29, _17$$3, _18$$3, _19$$3, _20$$3, _31$$4, _32$$4, _35$$4;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_0 = NULL, *_5 = NULL, *_7 = NULL, *_15 = NULL, *_23 = NULL, *_25 = NULL, *_26 = NULL, *_30 = NULL, *_33 = NULL;
	zval *this_ptr = getThis();
	...
	ZEPHIR_CALL_CE_STATIC(&path_now, brisk_kernel_app_ce, "getcontrollerdir", &_5, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_6, brisk_kernel_app_ce, "getbasedir", &_7, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_8, brisk_kernel_app_ce, "getcontrollerdir", &_5, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "");
	ZEPHIR_INIT_VAR(&ns_part);
	zephir_fast_str_replace(&ns_part, &_6, &_1, &_8 TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_9);
	ZEPHIR_INIT_VAR(&_10);
	...
	ZEPHIR_INIT_NVAR(&_11);
	ZVAL_STRING(&_11, "\\");
	zephir_fast_str_replace(&_9, &_10, &_11, &ns_part TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_12);
	ZVAL_STRING(&_12, "\\");
	ZEPHIR_INIT_NVAR(&ns_part);
	zephir_fast_trim(&ns_part, &_9, &_12, ZEPHIR_TRIM_BOTH TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_13);
	zephir_fast_explode_str(&_13, SL("\\"), &ns_part, LONG_MAX TSRMLS_CC);
	ZEPHIR_CPY_WRT(&ns_part, &_13);
	ZEPHIR_INIT_NVAR(&_13);
	ZVAL_STRING(&_13, "ucfirst");
	ZEPHIR_CALL_FUNCTION(&_14, "array_map", NULL, 70, &_13, &ns_part);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&ns_part, &_14);
	ZEPHIR_INIT_NVAR(&_13);
	zephir_fast_join_str(&_13, SL("\\"), &ns_part TSRMLS_CC);
	ZEPHIR_CPY_WRT(&ns_part, &_13);
	ZEPHIR_CALL_CE_STATIC(&_14, brisk_kernel_app_ce, "getname", &_15, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&ns_space);
	ZEPHIR_CONCAT_VSV(&ns_space, &_14, "\\", &ns_part);
	zephir_read_property(&_16, this_ptr, SL("_module"), PH_NOISY_CC | PH_READONLY);
	if (!ZEPHIR_IS_STRING(&_16, "")) {
		zephir_read_property(&_17$$3, this_ptr, SL("_module"), PH_NOISY_CC | PH_READONLY);
		ZEPHIR_INIT_VAR(&_18$$3);
		ZEPHIR_CONCAT_VSV(&_18$$3, &path_now, "/", &_17$$3);
		ZEPHIR_CPY_WRT(&path_now, &_18$$3);
		ZEPHIR_INIT_VAR(&_19$$3);
		zephir_read_property(&_20$$3, this_ptr, SL("_module"), PH_NOISY_CC | PH_READONLY);
		zephir_ucfirst(&_19$$3, &_20$$3);
		ZEPHIR_INIT_LNVAR(_18$$3);
		ZEPHIR_CONCAT_VSV(&_18$$3, &ns_space, "\\", &_19$$3);
		ZEPHIR_CPY_WRT(&ns_space, &_18$$3);
	}
	ZEPHIR_INIT_NVAR(&_13);
	zephir_read_property(&_21, this_ptr, SL("_controller"), PH_NOISY_CC | PH_READONLY);
	zephir_ucfirst(&_13, &_21);
	ZEPHIR_INIT_VAR(&_22);
	ZEPHIR_CONCAT_VSV(&_22, &ns_space, "\\", &_13);
	ZEPHIR_CPY_WRT(&ns_space, &_22);
	ZEPHIR_INIT_VAR(&_24);
	ZVAL_STRING(&_24, "~");
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_loader_ce, "setalias", &_23, 0, &_24, &path_now);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_request_ce, "setdata", &_25, 0, &params);
	zephir_check_call_status();
	ZVAL_BOOL(&_27, 1);
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_request_ce, "setready", &_26, 0, &_27);
	zephir_check_call_status();
	_28 = !(zephir_class_exists(&ns_space, zephir_is_true(&__$false)  TSRMLS_CC));
	if (_28) {
		ZEPHIR_CALL_CE_STATIC(&_29, brisk_kernel_loader_ce, "findclass", &_30, 0, &ns_space);
		zephir_check_call_status();
		_28 = !zephir_is_true(&_29);
	}
	if (_28) {
		ZEPHIR_INIT_VAR(&_31$$4);
		object_init_ex(&_31$$4, brisk_exception_routerexception_ce);
		ZEPHIR_INIT_VAR(&_34$$4);
		zephir_create_array(&_34$$4, 1, 0 TSRMLS_CC);
		zephir_array_fast_append(&_34$$4, &ns_space);
		ZEPHIR_INIT_VAR(&_35$$4);
		ZVAL_STRING(&_35$$4, "router.controller_not_found");
		ZEPHIR_CALL_CE_STATIC(&_32$$4, brisk_kernel_language_ce, "get", &_33, 0, &_35$$4, &_34$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_31$$4, "__construct", NULL, 3, &_32$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_31$$4, "brisk/Router/ClassicRouter.zep", 107 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}

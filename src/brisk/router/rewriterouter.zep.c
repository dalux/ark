...
PHP_METHOD(Brisk_Router_RewriteRouter, ready) {
	...
	zend_string *_35$$8;
	zend_ulong _34$$8;
	zval _71, _58$$13, _87$$14;
	zend_bool _44, _81, _31$$7, _54$$12;
	zval *_GET, __$false, uri, query, controller, url_suffix, _1, _2, _4, _5, _6, _7, _12, _13, _14, _15, _16, _21, _42, _43, _45, path_now, _49, ns_part, _65, _66, _67, _68, _69, _70, _72, _73, _74, _75, nspace, _76, _80, _82, _8$$3, _9$$3, _10$$3, _11$$3, _17$$5, _18$$5, _19$$5, _20$$5, _22$$7, _23$$7, _24$$7, _25$$7, _26$$7, _27$$7, _28$$7, _29$$7, list_query$$8, query_item$$8, query_name$$8, query_val$$8, _32$$8, *_33$$8, _36$$9, _37$$9, _38$$9, _39$$9, _40$$9, _41$$9, _46$$11, _47$$11, _48$$11, controllers$$12, dist$$12, _50$$12, _51$$12, _53$$12, _55$$12, _56$$12, _61$$12, _62$$12, _63$$12, _64$$12, _57$$13, _59$$13, _60$$13, c$$13, _84$$14, _85$$14, _88$$14;
	zend_long ZEPHIR_LAST_CALL_STATUS;
	zephir_fcall_cache_entry *_0 = NULL, *_3 = NULL, *_30 = NULL, *_52 = NULL, *_77 = NULL, *_78 = NULL, *_79 = NULL, *_83 = NULL, *_86 = NULL;
	zval *this_ptr = getThis();
	...
	ZEPHIR_CALL_CE_STATIC(&_49, brisk_kernel_app_ce, "getinstance", &_3, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&path_now, &_49, "getcontrollerdir", NULL, 0);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_65, brisk_kernel_app_ce, "getinstance", &_3, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_67);
	ZVAL_STRING(&_67, "base_dir");
	ZEPHIR_CALL_METHOD(&_66, &_65, "getapp", NULL, 0, &_67);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_68, brisk_kernel_app_ce, "getinstance", &_3, 0);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_69, &_68, "getcontrollerdir", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_67);
	ZVAL_STRING(&_67, "");
	ZEPHIR_INIT_VAR(&ns_part);
	zephir_fast_str_replace(&ns_part, &_66, &_67, &_69 TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_70);
	ZEPHIR_INIT_VAR(&_71);
	zephir_create_array(&_71, 2, 0 TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_72);
	ZVAL_STRING(&_72, "/");
	zephir_array_fast_append(&_71, &_72);
	ZEPHIR_INIT_NVAR(&_72);
	ZVAL_STRING(&_72, "\\");
	zephir_array_fast_append(&_71, &_72);
	ZEPHIR_INIT_NVAR(&_72);
	ZVAL_STRING(&_72, "\\");
	zephir_fast_str_replace(&_70, &_71, &_72, &ns_part TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_73);
	ZVAL_STRING(&_73, "\\");
	ZEPHIR_INIT_NVAR(&ns_part);
	zephir_fast_trim(&ns_part, &_70, &_73, ZEPHIR_TRIM_BOTH TSRMLS_CC);
	ZEPHIR_INIT_VAR(&_74);
	zephir_fast_explode_str(&_74, SL("\\"), &ns_part, LONG_MAX TSRMLS_CC);
	ZEPHIR_CPY_WRT(&ns_part, &_74);
	ZEPHIR_INIT_NVAR(&_74);
	ZVAL_STRING(&_74, "ucfirst");
	ZEPHIR_CALL_FUNCTION(&_75, "array_map", &_52, 70, &_74, &ns_part);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&ns_part, &_75);
	ZEPHIR_INIT_NVAR(&_74);
	zephir_fast_join_str(&_74, SL("\\"), &ns_part TSRMLS_CC);
	ZEPHIR_CPY_WRT(&ns_part, &_74);
	ZEPHIR_CALL_CE_STATIC(&_75, brisk_kernel_app_ce, "getinstance", &_3, 0);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_74);
	ZVAL_STRING(&_74, "name");
	ZEPHIR_CALL_METHOD(&_76, &_75, "getapp", NULL, 0, &_74);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&nspace);
	ZEPHIR_CONCAT_VSVSV(&nspace, &_76, "\\", &ns_part, "\\", &controller);
	ZEPHIR_INIT_NVAR(&_74);
	ZVAL_STRING(&_74, "~");
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_loader_ce, "setalias", &_77, 0, &_74, &path_now);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_request_ce, "setdata", &_78, 0, _GET);
	zephir_check_call_status();
	ZVAL_BOOL(&_80, 1);
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_request_ce, "setready", &_79, 0, &_80);
	zephir_check_call_status();
	_81 = !(zephir_class_exists(&nspace, zephir_is_true(&__$false)  TSRMLS_CC));
	if (_81) {
		ZEPHIR_CALL_CE_STATIC(&_82, brisk_kernel_loader_ce, "findclass", &_83, 0, &nspace);
		zephir_check_call_status();
		_81 = !zephir_is_true(&_82);
	}
	if (_81) {
		ZEPHIR_INIT_VAR(&_84$$14);
		object_init_ex(&_84$$14, brisk_exception_routerexception_ce);
		ZEPHIR_INIT_VAR(&_87$$14);
		zephir_create_array(&_87$$14, 1, 0 TSRMLS_CC);
		zephir_array_fast_append(&_87$$14, &nspace);
		ZEPHIR_INIT_VAR(&_88$$14);
		ZVAL_STRING(&_88$$14, "router.controller_not_found");
		ZEPHIR_CALL_CE_STATIC(&_85$$14, brisk_kernel_language_ce, "get", &_86, 0, &_88$$14, &_87$$14);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_84$$14, "__construct", NULL, 3, &_85$$14);
		zephir_check_call_status();
		zephir_throw_exception_debug(&_84$$14, "brisk/Router/RewriteRouter.zep", 126 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}

...
zend_class_entry *brisk_vendor_db_dbfather_ce;
...
zend_class_entry *brisk_vendor_db_dbadapter_ce;
zend_class_entry *brisk_vendor_db_dbquerier_ce;
zend_class_entry *brisk_vendor_db_dbtoolkit_ce;
zend_class_entry *brisk_vendor_db_pdo_ce;
...
// TODO: Deprecated. Will be removed in future
	...
	ZEPHIR_INIT(Brisk_Vendor_Db_DbFather);
	...
	ZEPHIR_INIT(Brisk_Vendor_Db_DbAdapter);
	ZEPHIR_INIT(Brisk_Vendor_Db_DbQuerier);
	ZEPHIR_INIT(Brisk_Vendor_Db_DbToolkit);
	ZEPHIR_INIT(Brisk_Vendor_Db_Pdo);

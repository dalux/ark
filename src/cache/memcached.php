...
class Ark_Cache_Memcached extends Ark_Cache_Father
{
    ...
    function __construct($save_path, array $option = array())
    {
        if (!extension_loaded('memcached')) {
            throw new Ark_Cache_Exception(Ark_Language::get('cache.extension_load_failed', 'php_memcached'));
        }
        ...
        if (!$this->_container->getVersion()) {
            throw new Ark_Cache_Exception(Ark_Language::get('cache.cacher_create_failed', 'Memcached'));
        }
    }

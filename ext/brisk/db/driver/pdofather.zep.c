...
PHP_METHOD(Brisk_Db_Driver_PdoFather, __construct) {
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_timer_ce, "mark", &_0, 5, _1$$3);
		...
		ZEPHIR_CALL_CE_STATIC(&_2$$3, brisk_kernel_event_ce, "fire", &_3, 6, _1$$3, data$$3);
		zephir_check_temp_parameter(_1$$3);
		zephir_check_call_status_or_jump(try_end_1);
...
PHP_METHOD(Brisk_Db_Driver_PdoFather, query) {
	...
	ZEPHIR_CALL_CE_STATIC(&_0, brisk_kernel_event_ce, "fire", &_1, 6, _2, data);
	...
	ZEPHIR_CALL_METHOD(&smt, this_ptr, "_query", NULL, 8, _3, _4);
	zephir_check_call_status();
	result = 1;
	ZEPHIR_INIT_NVAR(_2);
	ZVAL_BOOL(_2, result);
	...
	ZEPHIR_CALL_CE_STATIC(&_0, brisk_kernel_event_ce, "fire", &_1, 6, _5, data);
...
PHP_METHOD(Brisk_Db_Driver_PdoFather, _query) {
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_CE_STATIC(&_15$$3, brisk_kernel_timer_ce, "lastused", &_16, 10);
		zephir_check_call_status_or_jump(try_end_1);
		ZEPHIR_SINIT_VAR(_17$$3);
		ZVAL_STRING(&_17$$3, "%.4f", 0);
		ZEPHIR_CALL_FUNCTION(&_18$$3, "sprintf", NULL, 11, &_17$$3, _15$$3);
		zephir_check_call_status_or_jump(try_end_1);
		zephir_array_fast_append(_13$$3, _18$$3);
		ZEPHIR_INIT_NVAR(_1$$3);
		ZVAL_STRING(_1$$3, "database", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_trace_ce, "set", &_12, 9, _1$$3, _13$$3);
		zephir_check_temp_parameter(_1$$3);
		zephir_check_call_status_or_jump(try_end_1);
		RETURN_CCTOR(smt);
	...
	if (EG(exception)) {
		...
		if (zephir_instance_of_ev(_19, php_pdo_get_exception() TSRMLS_CC)) {
			...
			ZEPHIR_CALL_CE_STATIC(&_21$$7, brisk_kernel_event_ce, "fire", &_22, 6, _23$$7, data$$7);
			...
			ZEPHIR_CALL_METHOD(NULL, _23$$7, "__construct", NULL, 7, _24$$7);
			zephir_check_call_status();

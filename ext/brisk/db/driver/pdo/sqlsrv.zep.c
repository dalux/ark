...
ZEPHIR_INIT_CLASS(Brisk_Db_Driver_Pdo_Sqlsrv) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Brisk\\Db\\Driver\\Pdo, Sqlsrv, brisk, db_driver_pdo_sqlsrv, brisk_db_driver_pdofather_ce, brisk_db_driver_pdo_sqlsrv_method_entry, 0);
...
PHP_METHOD(Brisk_Db_Driver_Pdo_Sqlsrv, __construct) {
	...
	zval *config_param = NULL, *setting_param = NULL, *dsn = NULL, *charset = NULL, *params = NULL, *_0, *_1, *_2, _3, *_10, *_11, _5$$3, *_6$$3 = NULL, *_7$$3, *_8$$4;
	...
	zephir_array_fetch_string(&_0, config, SL("host"), PH_NOISY | PH_READONLY, "brisk/Db/Driver/Pdo/Sqlsrv.zep", 11 TSRMLS_CC);
	zephir_array_fetch_string(&_1, config, SL("port"), PH_NOISY | PH_READONLY, "brisk/Db/Driver/Pdo/Sqlsrv.zep", 11 TSRMLS_CC);

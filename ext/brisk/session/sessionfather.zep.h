...
ZEND_BEGIN_ARG_INFO_EX(arginfo_brisk_session_sessionfather___construct, 0, 0, 0)
	ZEND_ARG_ARRAY_INFO(0, option, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_brisk_session_sessionfather_setexpiretime, 0, 0, 0)
...
ZEPHIR_INIT_FUNCS(brisk_session_sessionfather_method_entry) {
	PHP_ME(Brisk_Session_SessionFather, __construct, arginfo_brisk_session_sessionfather___construct, ZEND_ACC_PUBLIC|ZEND_ACC_CTOR)
	PHP_ME(Brisk_Session_SessionFather, setExpireTime, arginfo_brisk_session_sessionfather_setexpiretime, ZEND_ACC_PUBLIC)

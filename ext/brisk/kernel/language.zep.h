...
ZEND_BEGIN_ARG_INFO_EX(arginfo_brisk_kernel_language_addpackage, 0, 0, 1)
	ZEND_ARG_INFO(0, language)
	ZEND_ARG_ARRAY_INFO(0, package, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_brisk_kernel_language_addpackagefile, 0, 0, 2)
	ZEND_ARG_INFO(0, language)
	ZEND_ARG_INFO(0, path)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_brisk_kernel_language_getpackage, 0, 0, 0)
	ZEND_ARG_INFO(0, language)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(brisk_kernel_language_method_entry) {
	...
	PHP_ME(Brisk_Kernel_Language, addPackageFile, arginfo_brisk_kernel_language_addpackagefile, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)
	PHP_ME(Brisk_Kernel_Language, getPackage, arginfo_brisk_kernel_language_getpackage, ZEND_ACC_PUBLIC|ZEND_ACC_STATIC)

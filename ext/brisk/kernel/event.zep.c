	...
	for (
	  ...
	  ; zend_hash_move_forward_ex(_4, &_3)
		...
		if (!(Z_TYPE_P(data) == IS_ARRAY)) {
			...
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, _7$$5, "__construct", &_12, 7, _8$$5);
			zephir_check_call_status();
		...
		if (zephir_fast_count_int(diff$$4 TSRMLS_CC) > 0) {
			...
			ZEPHIR_CALL_CE_STATIC(&_15$$6, brisk_kernel_language_ce, "get", &_9, 12, _17$$6, _16$$6);
			zephir_check_temp_parameter(_17$$6);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, _14$$6, "__construct", &_12, 7, _15$$6);
			zephir_check_call_status();

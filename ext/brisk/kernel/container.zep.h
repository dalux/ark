...
ZEND_BEGIN_ARG_INFO_EX(arginfo_brisk_kernel_container_get, 0, 0, 1)
	ZEND_ARG_INFO(0, key)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(brisk_kernel_container_method_entry) {
	...
	PHP_ME(Brisk_Kernel_Container, getValue, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Brisk_Kernel_Container, get, arginfo_brisk_kernel_container_get, ZEND_ACC_PUBLIC)

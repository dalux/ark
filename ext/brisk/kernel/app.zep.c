...
PHP_METHOD(Brisk_Kernel_App, getInstance) {
	...
	if (Z_TYPE_P(_0) == IS_NULL) {
		...
		ZEPHIR_CALL_FUNCTION(&backtrace$$3, "debug_backtrace", NULL, 14);
		zephir_check_call_status();
		zephir_array_fetch_long(&_9$$3, backtrace$$3, 0, PH_NOISY | PH_READONLY, "brisk/Kernel/App.zep", 62 TSRMLS_CC);
		zephir_array_fetch_string(&_10$$3, _9$$3, SL("file"), PH_NOISY | PH_READONLY, "brisk/Kernel/App.zep", 62 TSRMLS_CC);
		ZEPHIR_CALL_FUNCTION(&_11$$3, "dirname", NULL, 16, _10$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_1$$3);
		ZVAL_STRING(_1$$3, ".", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_loader_ce, "setalias", &_8, 15, _1$$3, _11$$3);
		zephir_check_temp_parameter(_1$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_1$$3);
		ZVAL_STRING(_1$$3, "exception", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_handler_ce, "sethandler", &_12, 17, _1$$3);
		zephir_check_temp_parameter(_1$$3);
		zephir_check_call_status();
		...
		zephir_array_fast_append(_6$$3, _1$$3);
		ZEPHIR_CALL_FUNCTION(NULL, "spl_autoload_register", NULL, 18, _6$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_CE_STATIC(&_13$$3, brisk_kernel_server_ce, "iscli", &_14, 19);
		zephir_check_call_status();
		if (zephir_is_true(_13$$3)) {
			ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_server_ce, "initcli", &_15, 20);
			zephir_check_call_status();
		} else {
			ZEPHIR_SINIT_VAR(_16$$5);
			ZVAL_STRING(&_16$$5, "Content-type: text/html; charset=utf-8", 0);
			ZEPHIR_CALL_FUNCTION(NULL, "header", NULL, 21, &_16$$5);
			zephir_check_call_status();
		}
...
PHP_METHOD(Brisk_Kernel_App, setAlias) {
	...
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_loader_ce, "setalias", &_0, 15, alias, path);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Brisk_Kernel_App, setNameSpace) {
	...
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_loader_ce, "setnamespace", &_0, 22, nspace, path);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Brisk_Kernel_App, addLanguageFile) {
	...
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_language_ce, "addpackagefile", &_0, 23, language, path);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Brisk_Kernel_App, setLanguage) {
	...
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_language_ce, "setlanguage", &_0, 24, language);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Brisk_Kernel_App, addEvent) {
	...
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_event_ce, "add", &_0, 25, event, listener);
	zephir_check_call_status();
	RETURN_THIS();
...
PHP_METHOD(Brisk_Kernel_App, start) {
	...
	if (_1) {
		...
		ZEPHIR_CALL_CE_STATIC(&_4$$3, brisk_kernel_language_ce, "get", &_5, 26, _6$$3);
	...
	if (!(Z_TYPE_P(config) == IS_ARRAY)) {
		...
		ZEPHIR_CALL_CE_STATIC(&_10$$4, brisk_kernel_language_ce, "get", &_5, 26, _11$$4);
		zephir_check_temp_parameter(_11$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _9$$4, "__construct", NULL, 27, _10$$4);
		zephir_check_call_status();
	...
	if (_16) {
		ZEPHIR_CALL_CE_STATIC(&_17, brisk_kernel_server_ce, "iscli", &_18, 19);
		zephir_check_call_status();
	...
	if (_16) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "header", NULL, 21, _21$$5);
		zephir_check_call_status();
	}
	...
	ZEPHIR_CALL_FUNCTION(NULL, "date_default_timezone_set", NULL, 28, timezone);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_12);
	...
	if (zephir_is_true(_25)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(NULL, "error_reporting", NULL, 29, _30$$7);
		zephir_check_call_status();
	}
	ZEPHIR_INIT_VAR(_31);
	zephir_create_array(_31, 2, 0 TSRMLS_CC);
	ZEPHIR_CALL_CE_STATIC(&_32, brisk_kernel_router_routeradapter_ce, "getdriver", &_33, 30);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_event_ce, "fire", &_34, 31, _12);
	zephir_check_temp_parameter(_12);
	zephir_check_call_status();
	...
	if (!(zephir_instance_of_ev(_36, brisk_kernel_router_routerfather_ce TSRMLS_CC))) {
		...
		ZEPHIR_CALL_CE_STATIC(&lang$$8, brisk_kernel_language_ce, "get", &_5, 26, _38$$8, _37$$8);
		zephir_check_temp_parameter(_38$$8);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(_38$$8);
		object_init_ex(_38$$8, brisk_exception_routerexception_ce);
		ZEPHIR_CALL_METHOD(NULL, _38$$8, "__construct", NULL, 27, lang$$8);
		zephir_check_call_status();
		zephir_throw_exception_debug(_38$$8, "brisk/Kernel/App.zep", 182 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Brisk_Kernel_App, setComponent) {
	...
	if (!(_1)) {
		...
		zephir_array_fetch(&_3, _2, name, PH_NOISY | PH_READONLY, "brisk/Kernel/App.zep", 202 TSRMLS_CC);
		zephir_array_fetch_string(&_4, _3, SL("system"), PH_NOISY | PH_READONLY, "brisk/Kernel/App.zep", 202 TSRMLS_CC);
...
PHP_METHOD(Brisk_Kernel_App, getComponent) {
	...
	_0 = zephir_fetch_static_property_ce(brisk_kernel_app_ce, SL("_storage") TSRMLS_CC);
	zephir_array_fetch(&_1, _0, name, PH_NOISY | PH_READONLY, "brisk/Kernel/App.zep", 217 TSRMLS_CC);
	ZEPHIR_OBS_VAR(instance);
	zephir_array_fetch_string(&instance, _1, SL("instance"), PH_NOISY, "brisk/Kernel/App.zep", 217 TSRMLS_CC);
	if (Z_TYPE_P(instance) == IS_NULL) {
		...
		ZEPHIR_CALL_CE_STATIC(&_3$$3, brisk_kernel_language_ce, "get", &_4, 26, _6$$3, _5$$3);
		zephir_check_temp_parameter(_6$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _2$$3, "__construct", NULL, 27, _3$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(_2$$3, "brisk/Kernel/App.zep", 219 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
		...
		if (!zephir_is_true(instance)) {
			...
			ZEPHIR_CALL_CE_STATIC(&_10$$5, brisk_kernel_language_ce, "get", &_4, 26, _12$$5, _11$$5);
			zephir_check_temp_parameter(_12$$5);
			zephir_check_call_status();
			ZEPHIR_CALL_METHOD(NULL, _9$$5, "__construct", NULL, 27, _10$$5);
			zephir_check_call_status();
			zephir_throw_exception_debug(_9$$5, "brisk/Kernel/App.zep", 223 TSRMLS_CC);
			ZEPHIR_MM_RESTORE();
			return;
		}
...
PHP_METHOD(Brisk_Kernel_App, setMethod) {
	...
	if (!(zephir_is_callable(method TSRMLS_CC))) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_0$$3, "brisk/Kernel/App.zep", 251 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Brisk_Kernel_App, callMethod) {
	...
	if (!(zephir_array_isset(_0, name))) {
		...
		ZEPHIR_CALL_CE_STATIC(&_2$$3, brisk_kernel_language_ce, "get", &_3, 26, _5$$3, _4$$3);
		zephir_check_temp_parameter(_5$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _1$$3, "__construct", NULL, 27, _2$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(_1$$3, "brisk/Kernel/App.zep", 267 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	_6 = zephir_fetch_static_property_ce(brisk_kernel_app_ce, SL("_methods") TSRMLS_CC);
	ZEPHIR_OBS_VAR(method);
	zephir_array_fetch(&method, _6, name, PH_NOISY, "brisk/Kernel/App.zep", 269 TSRMLS_CC);
...
PHP_METHOD(Brisk_Kernel_App, __destruct) {
	...
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_event_ce, "fire", &_4, 31, _1);
	zephir_check_temp_parameter(_1);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();

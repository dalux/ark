...
ZEPHIR_INIT_CLASS(Brisk_Vendor_Database_DbToolkit) {

	ZEPHIR_REGISTER_CLASS(Brisk\\Vendor\\Database, DbToolkit, brisk, vendor_database_dbtoolkit, brisk_vendor_database_dbtoolkit_method_entry, 0);
 ...
 * @return array
 */
PHP_METHOD(Brisk_Vendor_Database_DbToolkit, parseConnectUrl) {
	...
	ZEPHIR_OBS_VAR(_5);
	zephir_array_fetch_string(&_5, parsed, SL("scheme"), PH_NOISY, "brisk/Vendor/Database/DbToolkit.zep", 24 TSRMLS_CC);
	zephir_array_update_string(&config, SL("type"), &_5, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(_5);
	zephir_array_fetch_string(&_5, parsed, SL("host"), PH_NOISY, "brisk/Vendor/Database/DbToolkit.zep", 25 TSRMLS_CC);
	zephir_array_update_string(&config, SL("host"), &_5, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(_5);
	zephir_array_fetch_string(&_5, parsed, SL("port"), PH_NOISY, "brisk/Vendor/Database/DbToolkit.zep", 26 TSRMLS_CC);
	zephir_array_update_string(&config, SL("port"), &_5, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(_5);
	zephir_array_fetch_string(&_5, parsed, SL("user"), PH_NOISY, "brisk/Vendor/Database/DbToolkit.zep", 27 TSRMLS_CC);
	zephir_array_update_string(&config, SL("user"), &_5, PH_COPY | PH_SEPARATE);
	ZEPHIR_OBS_NVAR(_5);
	zephir_array_fetch_string(&_5, parsed, SL("pass"), PH_NOISY, "brisk/Vendor/Database/DbToolkit.zep", 28 TSRMLS_CC);
	zephir_array_update_string(&config, SL("pass"), &_5, PH_COPY | PH_SEPARATE);
	ZEPHIR_INIT_VAR(_6);
	zephir_array_fetch_string(&_7, parsed, SL("path"), PH_NOISY | PH_READONLY, "brisk/Vendor/Database/DbToolkit.zep", 29 TSRMLS_CC);
	ZEPHIR_SINIT_VAR(_8);
	ZVAL_STRING(&_8, "/", 0);
	...
	zephir_array_fetch_string(&query, parsed, SL("query"), PH_NOISY, "brisk/Vendor/Database/DbToolkit.zep", 32 TSRMLS_CC);
	if (!ZEPHIR_IS_STRING(query, "")) {
		ZEPHIR_INIT_VAR(_9$$4);
		zephir_fast_explode_str(_9$$4, SL("&"), query, LONG_MAX TSRMLS_CC);
		ZEPHIR_CPY_WRT(query, _9$$4);
		ZEPHIR_INIT_NVAR(_9$$4);
		zephir_is_iterable(query, &_11$$4, &_10$$4, 0, 0, "brisk/Vendor/Database/DbToolkit.zep", 42);
		for (
		  ...
		  ; zend_hash_move_forward_ex(_11$$4, &_10$$4)
			...
			zephir_array_fetch_long(&_13$$5, expr$$4, 0, PH_NOISY | PH_READONLY, "brisk/Vendor/Database/DbToolkit.zep", 38 TSRMLS_CC);
			_14$$5 = zephir_is_true(_13$$5);
			if (_14$$5) {
				zephir_array_fetch_long(&_15$$5, expr$$4, 1, PH_NOISY | PH_READONLY, "brisk/Vendor/Database/DbToolkit.zep", 38 TSRMLS_CC);
				_14$$5 = !ZEPHIR_IS_STRING_IDENTICAL(_15$$5, "");
			}
			if (_14$$5) {
				zephir_array_fetch_long(&_16$$6, expr$$4, 1, PH_NOISY | PH_READONLY, "brisk/Vendor/Database/DbToolkit.zep", 39 TSRMLS_CC);
				ZEPHIR_OBS_NVAR(_17$$6);
				zephir_array_fetch_long(&_17$$6, expr$$4, 0, PH_NOISY, "brisk/Vendor/Database/DbToolkit.zep", 39 TSRMLS_CC);

...
ZEPHIR_INIT_CLASS(Brisk_View_Driver_Native) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Brisk\\View\\Driver, Native, brisk, view_driver_native, brisk_view_viewfather_ce, brisk_view_driver_native_method_entry, 0);

	zend_declare_property_null(brisk_view_driver_native_ce, SL("_storage"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_string(brisk_view_driver_native_ce, SL("_template_ext"), ".phtml", ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(brisk_view_driver_native_ce, SL("_template_dir"), ZEND_ACC_PRIVATE TSRMLS_CC);

	brisk_view_driver_native_ce->create_object = zephir_init_properties_Brisk_View_Driver_Native;
	return SUCCESS;
...
PHP_METHOD(Brisk_View_Driver_Native, __construct) {
	...
	if (zephir_array_isset_string(options, SS("template_ext"))) {
		zephir_array_fetch_string(&_0$$3, options, SL("template_ext"), PH_NOISY | PH_READONLY, "brisk/View/Driver/Native.zep", 28 TSRMLS_CC);
	...
	if (zephir_array_isset_string(options, SS("template_dir"))) {
		...
		zephir_array_fetch_string(&_2$$4, options, SL("template_dir"), PH_NOISY | PH_READONLY, "brisk/View/Driver/Native.zep", 31 TSRMLS_CC);
...
PHP_METHOD(Brisk_View_Driver_Native, get) {
	...
	if (ZEPHIR_IS_STRING(name, "")) {
		...
		zephir_array_fetch(&_0, _1, name, PH_NOISY, "brisk/View/Driver/Native.zep", 56 TSRMLS_CC);
	}
	RETURN_CCTOR(_0);
...
PHP_METHOD(Brisk_View_Driver_Native, display) {
	...
	ZEPHIR_CALL_FUNCTION(&_6, "is_file", NULL, 81, template);
	...
	if (!zephir_is_true(_6)) {
		...
		ZEPHIR_CALL_CE_STATIC(&_11$$4, brisk_kernel_loader_ce, "reducepath", &_12, 129, template);
		zephir_check_call_status();
		zephir_array_fast_append(_10$$4, _11$$4);
		ZEPHIR_INIT_VAR(_13$$4);
		ZVAL_STRING(_13$$4, "view.template_not_found", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_CE_STATIC(&_8$$4, brisk_kernel_language_ce, "get", &_9, 13, _13$$4, _10$$4);
		zephir_check_temp_parameter(_13$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _7$$4, "__construct", NULL, 8, _8$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(_7$$4, "brisk/View/Driver/Native.zep", 73 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	ZEPHIR_CALL_CE_STATIC(&_14, brisk_kernel_event_ce, "fire", &_15, 7, _16, data);
	...
	ZVAL_LONG(_16, 256);
	ZEPHIR_MAKE_REF(_17);
	ZEPHIR_CALL_FUNCTION(NULL, "extract", NULL, 130, _17, _16);
	ZEPHIR_UNREF(_17);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&_14, "ob_get_clean", NULL, 92);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_18, brisk_kernel_event_ce, "fire", &_15, 7, _16, data);
	zephir_check_temp_parameter(_16);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(data, _18);
	if (output) {
		zephir_array_fetch_string(&_19$$5, data, SL("content"), PH_NOISY | PH_READONLY, "brisk/View/Driver/Native.zep", 87 TSRMLS_CC);
		zend_print_zval(_19$$5, 0);
		ZEPHIR_MM_RESTORE();
		zephir_exit_empty();
	}
	zephir_array_fetch_string(&_20, data, SL("content"), PH_NOISY | PH_READONLY, "brisk/View/Driver/Native.zep", 90 TSRMLS_CC);
	RETURN_CTOR(_20);
...
PHP_METHOD(Brisk_View_Driver_Native, import) {
	...
	ZEPHIR_CALL_FUNCTION(&_5, "is_file", NULL, 81, template);
	zephir_check_call_status();
	if (!zephir_is_true(_5)) {
		...
		ZEPHIR_CALL_CE_STATIC(&_10$$4, brisk_kernel_loader_ce, "reducepath", &_11, 129, template);
		zephir_check_call_status();
		zephir_array_fast_append(_9$$4, _10$$4);
		ZEPHIR_INIT_VAR(_12$$4);
		ZVAL_STRING(_12$$4, "view.include_file_not_found", ZEPHIR_TEMP_PARAM_COPY);
		ZEPHIR_CALL_CE_STATIC(&_7$$4, brisk_kernel_language_ce, "get", &_8, 13, _12$$4, _9$$4);
		zephir_check_temp_parameter(_12$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _6$$4, "__construct", NULL, 8, _7$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(_6$$4, "brisk/View/Driver/Native.zep", 109 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	ZVAL_LONG(_14, 256);
	ZEPHIR_MAKE_REF(_13);
	ZEPHIR_CALL_FUNCTION(NULL, "extract", &_15, 130, _13, _14);
	ZEPHIR_UNREF(_13);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(_14);
	ZVAL_LONG(_14, 1);
	ZEPHIR_MAKE_REF(params);
	ZEPHIR_CALL_FUNCTION(NULL, "extract", &_15, 130, params, _14);
	ZEPHIR_UNREF(params);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(NULL, "ob_start", NULL, 91);
	zephir_check_call_status();

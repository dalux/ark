...
PHP_METHOD(Brisk_View_ViewAdapter, getDriverFromConfig) {
	...
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_5, brisk_kernel_app_ce, "getinstance", &_1, 21);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(_6);
	...
	if (!zephir_is_true(_3)) {
		...
		ZEPHIR_CALL_CE_STATIC(&_9$$3, brisk_kernel_language_ce, "get", &_10, 12, _12$$3, _11$$3);
		zephir_check_temp_parameter(_12$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _8$$3, "__construct", NULL, 7, _9$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_CE_STATIC(&_14$$4, brisk_kernel_language_ce, "get", &_10, 12, _16$$4, _15$$4);
		zephir_check_temp_parameter(_16$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _13$$4, "__construct", NULL, 7, _14$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(_13$$4, "brisk/View/ViewAdapter.zep", 25 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_CALL_CE_STATIC(&_17, brisk_kernel_app_ce, "getinstance", &_1, 21);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(_18);
	...
	zephir_check_temp_parameter(_4);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_19, brisk_kernel_app_ce, "getinstance", &_1, 21);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(_20);
	...
	zephir_check_temp_parameter(_4);
	zephir_check_call_status();
	ZEPHIR_CALL_CE_STATIC(&_21, brisk_kernel_toolkit_ce, "classdeclared", &_22, 22, driver);
	zephir_check_call_status();
	_23 = !zephir_is_true(_21);
	if (_23) {
		ZEPHIR_CALL_CE_STATIC(&_24, brisk_kernel_loader_ce, "findclass", &_25, 23, driver);
		zephir_check_call_status();
	...
	if (_23) {
		...
		ZEPHIR_CALL_CE_STATIC(&_27$$5, brisk_kernel_language_ce, "get", &_10, 12, _29$$5, _28$$5);
		zephir_check_temp_parameter(_29$$5);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _26$$5, "__construct", NULL, 7, _27$$5);
		zephir_check_call_status();
	...
	if (!((zephir_instance_of_ev(instance, brisk_view_viewfather_ce TSRMLS_CC)))) {
		...
		ZEPHIR_CALL_CE_STATIC(&_33$$6, brisk_kernel_language_ce, "get", &_10, 12, _35$$6, _34$$6);
		zephir_check_temp_parameter(_35$$6);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _32$$6, "__construct", NULL, 7, _33$$6);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_kernel_trace_ce, "set", &_36, 9, _4, _37);
	zephir_check_temp_parameter(_4);
	zephir_check_call_status();

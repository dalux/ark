...
ZEPHIR_INIT_CLASS(Brisk_Router_Driver_Classic) {
	...
	ZEPHIR_REGISTER_CLASS_EX(Brisk\\Router\\Driver, Classic, brisk, router_driver_classic, brisk_router_routerfather_ce, brisk_router_driver_classic_method_entry, 0);

	zend_declare_property_bool(brisk_router_driver_classic_ce, SL("_module_support"), 0, ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_null(brisk_router_driver_classic_ce, SL("_rules"), ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_string(brisk_router_driver_classic_ce, SL("_auto_method"), "__init", ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_string(brisk_router_driver_classic_ce, SL("_default_module"), "Index", ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_string(brisk_router_driver_classic_ce, SL("_default_controller"), "Index", ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_string(brisk_router_driver_classic_ce, SL("_default_action"), "index", ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_string(brisk_router_driver_classic_ce, SL("_url_suffix"), ".html", ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_null(brisk_router_driver_classic_ce, SL("_interceptors"), ZEND_ACC_PRIVATE|ZEND_ACC_STATIC TSRMLS_CC);

	zend_declare_property_null(brisk_router_driver_classic_ce, SL("_module"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(brisk_router_driver_classic_ce, SL("_controller"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(brisk_router_driver_classic_ce, SL("_action"), ZEND_ACC_PRIVATE TSRMLS_CC);

	zend_declare_property_null(brisk_router_driver_classic_ce, SL("_namespace"), ZEND_ACC_PRIVATE TSRMLS_CC);
...
PHP_METHOD(Brisk_Router_Driver_Classic, openModuleSupport) {
	...
	zephir_update_static_property_ce(brisk_router_driver_classic_ce, SL("_module_support"), &ZEPHIR_GLOBAL(global_true) TSRMLS_CC);
	if (!ZEPHIR_IS_STRING(default_module, "")) {
		zephir_update_static_property_ce(brisk_router_driver_classic_ce, SL("_default_module"), &default_module TSRMLS_CC);
	}
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Brisk_Router_Driver_Classic, addRule) {
	...
	zephir_update_static_property_array_multi_ce(brisk_router_driver_classic_ce, SL("_rules"), &redirect TSRMLS_CC, SL("z"), 1, rule);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Brisk_Router_Driver_Classic, addInterceptor) {
	...
	zephir_update_static_property_array_multi_ce(brisk_router_driver_classic_ce, SL("_interceptors"), &operator TSRMLS_CC, SL("z"), 1, ns_space);
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Brisk_Router_Driver_Classic, getInterceptors) {
	...
	array_init(result);
	_2 = zephir_fetch_static_property_ce(brisk_router_driver_classic_ce, SL("_interceptors") TSRMLS_CC);
	zephir_is_iterable(_2, &_4, &_3, 0, 0, "brisk/Router/Driver/Classic.zep", 100);
	for (
	...
	if (zephir_fast_count_int(result TSRMLS_CC) > 0) {
		...
		object_init_ex(_8$$5, brisk_router_driver_classic_ce);
...
PHP_METHOD(Brisk_Router_Driver_Classic, ready) {
	...
	if (!zephir_is_true(_3)) {
		...
		zephir_check_call_status();
		zephir_throw_exception_debug(_5$$3, "brisk/Router/Driver/Classic.zep", 114 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	zephir_check_call_status();
	zephir_array_fetch_string(&_15, result, SL("module"), PH_NOISY | PH_READONLY, "brisk/Router/Driver/Classic.zep", 123 TSRMLS_CC);
	zephir_update_property_this(getThis(), SL("_module"), _15 TSRMLS_CC);
	zephir_array_fetch_string(&_16, result, SL("controller"), PH_NOISY | PH_READONLY, "brisk/Router/Driver/Classic.zep", 124 TSRMLS_CC);
	zephir_update_property_this(getThis(), SL("_controller"), _16 TSRMLS_CC);
	zephir_array_fetch_string(&_17, result, SL("action"), PH_NOISY | PH_READONLY, "brisk/Router/Driver/Classic.zep", 125 TSRMLS_CC);
	zephir_update_property_this(getThis(), SL("_action"), _17 TSRMLS_CC);
	ZEPHIR_OBS_VAR(params);
	zephir_array_fetch_string(&params, result, SL("params"), PH_NOISY, "brisk/Router/Driver/Classic.zep", 126 TSRMLS_CC);
	...
	ZEPHIR_INIT_VAR(_26);
	ZVAL_BOOL(_26, 1);
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_http_request_ce, "setready", &_25, 105, _26);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
...
PHP_METHOD(Brisk_Router_Driver_Classic, dispatch) {
	...
	ZEPHIR_CALL_CE_STATIC(&_0, brisk_kernel_toolkit_ce, "classdeclared", &_1, 22, ns_space);
	zephir_check_call_status();
	_2 = !zephir_is_true(_0);
	if (_2) {
		ZEPHIR_CALL_CE_STATIC(&_3, brisk_kernel_loader_ce, "findclass", &_4, 23, ns_space);
		zephir_check_call_status();
	...
	if (_2) {
		...
		ZEPHIR_CALL_METHOD(NULL, _5$$3, "__construct", NULL, 7, _6$$3);
		zephir_check_call_status();
		zephir_throw_exception_debug(_5$$3, "brisk/Router/Driver/Classic.zep", 151 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
		...
		ZEPHIR_CALL_CE_STATIC(&_11$$4, brisk_kernel_language_ce, "get", &_7, 12, _13$$4, _12$$4);
		zephir_check_temp_parameter(_13$$4);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _10$$4, "__construct", NULL, 7, _11$$4);
		zephir_check_call_status();
		zephir_throw_exception_debug(_10$$4, "brisk/Router/Driver/Classic.zep", 153 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	ZEPHIR_INIT_VAR(ref);
	...
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(&_14, ref, "isabstract", NULL, 107);
	zephir_check_call_status();
	if (zephir_is_true(_14)) {
		...
		ZEPHIR_CALL_CE_STATIC(&_16$$5, brisk_kernel_language_ce, "get", &_7, 12, _18$$5, _17$$5);
		zephir_check_temp_parameter(_18$$5);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _15$$5, "__construct", NULL, 7, _16$$5);
		zephir_check_call_status();
		zephir_throw_exception_debug(_15$$5, "brisk/Router/Driver/Classic.zep", 159 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	...
	if (zephir_fast_count_int(interceptors TSRMLS_CC) > 0) {
		...
		zephir_is_iterable(interceptors, &_21$$6, &_20$$6, 0, 0, "brisk/Router/Driver/Classic.zep", 173);
		for (
	...
	ZEPHIR_CALL_CE_STATIC(&_26, brisk_kernel_app_ce, "getinstance", &_27, 21);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(_28);
	zephir_read_property(&_28, _26, SL("config"), PH_NOISY_CC);
	ZEPHIR_INIT_VAR(_29);
	ZVAL_STRING(_29, "router/option", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_METHOD(&option, _28, "get", NULL, 0, _29);
	zephir_check_temp_parameter(_29);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(auto_method);
	zephir_read_static_property_ce(&auto_method, brisk_router_driver_classic_ce, SL("_auto_method") TSRMLS_CC);
	if (zephir_array_isset_string(option, SS("auto_method"))) {
		ZEPHIR_OBS_NVAR(auto_method);
		zephir_array_fetch_string(&auto_method, option, SL("auto_method"), PH_NOISY, "brisk/Router/Driver/Classic.zep", 181 TSRMLS_CC);
	}
	if (!((zephir_method_exists(instance, action TSRMLS_CC)  == SUCCESS))) {
		...
		ZEPHIR_CALL_CE_STATIC(&_31$$10, brisk_kernel_language_ce, "get", &_7, 12, _33$$10, _32$$10);
		zephir_check_temp_parameter(_33$$10);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _30$$10, "__construct", NULL, 7, _31$$10);
		zephir_check_call_status();
		zephir_throw_exception_debug(_30$$10, "brisk/Router/Driver/Classic.zep", 184 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
...
PHP_METHOD(Brisk_Router_Driver_Classic, _parseUri) {
	...
	zephir_read_property(&_2, _0, SL("config"), PH_NOISY_CC);
	ZEPHIR_INIT_VAR(_3);
	ZVAL_STRING(_3, "router/option", ZEPHIR_TEMP_PARAM_COPY);
	...
	if (_9) {
		...
		_10$$3 = zephir_fetch_static_property_ce(brisk_router_driver_classic_ce, SL("_module_support") TSRMLS_CC);
		if (zephir_is_true(_10$$3)) {
			ZEPHIR_OBS_NVAR(module);
			zephir_read_static_property_ce(&module, brisk_router_driver_classic_ce, SL("_default_module") TSRMLS_CC);
		}
		ZEPHIR_OBS_VAR(controller);
		zephir_read_static_property_ce(&controller, brisk_router_driver_classic_ce, SL("_default_controller") TSRMLS_CC);
		ZEPHIR_OBS_VAR(action);
		zephir_read_static_property_ce(&action, brisk_router_driver_classic_ce, SL("_default_action") TSRMLS_CC);
		if (zephir_array_isset_string(config, SS("default_controller"))) {
			ZEPHIR_OBS_NVAR(controller);
			zephir_array_fetch_string(&controller, config, SL("default_controller"), PH_NOISY, "brisk/Router/Driver/Classic.zep", 227 TSRMLS_CC);
		}
		if (zephir_array_isset_string(config, SS("default_action"))) {
			ZEPHIR_OBS_NVAR(action);
			zephir_array_fetch_string(&action, config, SL("default_action"), PH_NOISY, "brisk/Router/Driver/Classic.zep", 230 TSRMLS_CC);
		}
	...
	zephir_read_static_property_ce(&url_suffix, brisk_router_driver_classic_ce, SL("_url_suffix") TSRMLS_CC);
	if (zephir_array_isset_string(config, SS("url_suffix"))) {
		ZEPHIR_OBS_NVAR(url_suffix);
		zephir_array_fetch_string(&url_suffix, config, SL("url_suffix"), PH_NOISY, "brisk/Router/Driver/Classic.zep", 241 TSRMLS_CC);
	}
	...
	ZEPHIR_CALL_METHOD(&_16, this_ptr, "_rewrite", NULL, 108, uri);
	zephir_check_call_status();
	...
	ZVAL_STRING(module, "", 1);
	_20 = zephir_fetch_static_property_ce(brisk_router_driver_classic_ce, SL("_module_support") TSRMLS_CC);
	if (zephir_is_true(_20)) {
		ZEPHIR_MAKE_REF(uri_items);
		ZEPHIR_CALL_FUNCTION(&module, "array_shift", &_21, 15, uri_items);
		ZEPHIR_UNREF(uri_items);
		zephir_check_call_status();
	}
	ZEPHIR_MAKE_REF(uri_items);
	ZEPHIR_CALL_FUNCTION(&controller, "array_shift", &_21, 15, uri_items);
	ZEPHIR_UNREF(uri_items);
	zephir_check_call_status();
	...
	ZEPHIR_MAKE_REF(uri_items);
	ZEPHIR_CALL_FUNCTION(&action, "array_shift", &_21, 15, uri_items);
	ZEPHIR_UNREF(uri_items);
	zephir_check_call_status();
	...
	if (zephir_fast_count_int(uri_items TSRMLS_CC) > 0) {
		...
		ZVAL_LONG(&_22$$12, 2);
		ZEPHIR_CALL_FUNCTION(&_23$$12, "array_chunk", NULL, 109, uri_items, &_22$$12);
		zephir_check_call_status();
		ZEPHIR_CPY_WRT(uri_items, _23$$12);
		ZEPHIR_INIT_VAR(_24$$12);
		zephir_is_iterable(uri_items, &_26$$12, &_25$$12, 0, 0, "brisk/Router/Driver/Classic.zep", 272);
		for (
		  ...
		  ; zend_hash_move_forward_ex(_26$$12, &_25$$12)
			...
			zephir_array_fetch_long(&_28$$13, val, 1, PH_NOISY | PH_READONLY, "brisk/Router/Driver/Classic.zep", 270 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(_29$$13);
			zephir_array_fetch_long(&_29$$13, val, 0, PH_NOISY, "brisk/Router/Driver/Classic.zep", 270 TSRMLS_CC);
	...
	if (!ZEPHIR_IS_STRING(query, "")) {
		...
		zephir_is_iterable(query, &_32$$14, &_31$$14, 0, 0, "brisk/Router/Driver/Classic.zep", 279);
		for (
		  ...
		  ; zend_hash_move_forward_ex(_32$$14, &_31$$14)
			...
			zephir_array_fetch_long(&_35$$15, val, 1, PH_NOISY | PH_READONLY, "brisk/Router/Driver/Classic.zep", 277 TSRMLS_CC);
			ZEPHIR_OBS_NVAR(_36$$15);
			zephir_array_fetch_long(&_36$$15, val, 0, PH_NOISY, "brisk/Router/Driver/Classic.zep", 277 TSRMLS_CC);
			zephir_array_update_zval(&result, _36$$15, &_35$$15, PH_COPY | PH_SEPARATE);
		}
	}
	if (zephir_array_isset_string(result, SS("_m"))) {
		ZEPHIR_OBS_NVAR(module);
		zephir_array_fetch_string(&module, result, SL("_m"), PH_NOISY, "brisk/Router/Driver/Classic.zep", 281 TSRMLS_CC);
		zephir_array_unset_string(&result, SS("_m"), PH_SEPARATE);
	}
	if (zephir_array_isset_string(result, SS("_c"))) {
		ZEPHIR_OBS_NVAR(controller);
		zephir_array_fetch_string(&controller, result, SL("_c"), PH_NOISY, "brisk/Router/Driver/Classic.zep", 285 TSRMLS_CC);
		zephir_array_unset_string(&result, SS("_c"), PH_SEPARATE);
	}
	if (zephir_array_isset_string(result, SS("_a"))) {
		ZEPHIR_OBS_NVAR(action);
		zephir_array_fetch_string(&action, result, SL("_a"), PH_NOISY, "brisk/Router/Driver/Classic.zep", 289 TSRMLS_CC);
...
PHP_METHOD(Brisk_Router_Driver_Classic, _rewrite) {
	...
	_0 = zephir_fetch_static_property_ce(brisk_router_driver_classic_ce, SL("_rules") TSRMLS_CC);
	zephir_is_iterable(_0, &_2, &_1, 0, 0, "brisk/Router/Driver/Classic.zep", 317);
	for (
	  ...
	  ; zend_hash_move_forward_ex(_2, &_1)
		...
		if (zephir_is_true(_6$$3)) {
			...
			if (Z_TYPE_P(val) == IS_STRING) {
				...
				zephir_array_fetch_long(&_16$$7, val, 0, PH_NOISY | PH_READONLY, "brisk/Router/Driver/Classic.zep", 313 TSRMLS_CC);
				zephir_array_fetch_long(&_17$$7, val, 1, PH_NOISY | PH_READONLY, "brisk/Router/Driver/Classic.zep", 313 TSRMLS_CC);
				...
				zephir_check_call_status();
				ZEPHIR_CALL_METHOD(NULL, _12$$7, "__construct", &_20, 7, _13$$7);
				zephir_check_call_status();
				zephir_throw_exception_debug(_12$$7, "brisk/Router/Driver/Classic.zep", 313 TSRMLS_CC);
				ZEPHIR_MM_RESTORE();
				return;
			}
		}
	...
	if (!(Z_TYPE_P(uri) == IS_STRING)) {
		...
		ZEPHIR_CALL_CE_STATIC(&_22$$8, brisk_kernel_language_ce, "get", &_14, 12, _23$$8);
		zephir_check_temp_parameter(_23$$8);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _21$$8, "__construct", &_20, 7, _22$$8);
		zephir_check_call_status();
		zephir_throw_exception_debug(_21$$8, "brisk/Router/Driver/Classic.zep", 318 TSRMLS_CC);
		ZEPHIR_MM_RESTORE();
		return;
	}
	RETURN_CTOR(uri);
...
void zephir_init_static_properties_Brisk_Router_Driver_Classic(TSRMLS_D) {
	...
	ZEPHIR_INIT_VAR(_0);
	array_init(_0);
	zephir_update_static_property_ce(brisk_router_driver_classic_ce, SL("_interceptors"), &_0 TSRMLS_CC);
	ZEPHIR_INIT_VAR(_1);
	array_init(_1);
	zephir_update_static_property_ce(brisk_router_driver_classic_ce, SL("_rules"), &_1 TSRMLS_CC);
	ZEPHIR_MM_RESTORE();

...
PHP_METHOD(Brisk_Router_Driver_Classic, ready) {
	...
	ZEPHIR_CALL_CE_STATIC(NULL, brisk_http_request_ce, "setdata", &_24, 86, params);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(_26);
	ZVAL_BOOL(_26, 1);
...
PHP_METHOD(Brisk_Router_Driver_Classic, dispatch) {
	...
	if (zephir_is_true(_14)) {
		...
		ZEPHIR_CALL_CE_STATIC(&_16$$5, brisk_kernel_language_ce, "get", &_7, 13, _18$$5, _17$$5);
		zephir_check_temp_parameter(_18$$5);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _15$$5, "__construct", NULL, 8, _16$$5);
		zephir_check_call_status();
	...
	ZEPHIR_CALL_CE_STATIC(&_26, brisk_kernel_app_ce, "getinstance", &_27, 22);
	zephir_check_call_status();
	ZEPHIR_OBS_VAR(_28);
	...
	if (!((zephir_method_exists(instance, action TSRMLS_CC)  == SUCCESS))) {
		...
		ZEPHIR_CALL_CE_STATIC(&_31$$10, brisk_kernel_language_ce, "get", &_7, 13, _33$$10, _32$$10);
		zephir_check_temp_parameter(_33$$10);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, _30$$10, "__construct", NULL, 8, _31$$10);
		zephir_check_call_status();
...
PHP_METHOD(Brisk_Router_Driver_Classic, _parseUri) {
	...
	ZEPHIR_CALL_FUNCTION(&_7, "preg_replace", &_8, 5, _6, _3, uri);
	zephir_check_temp_parameter(_3);
	zephir_check_call_status();
	...
	ZEPHIR_INIT_NVAR(_3);
	ZVAL_STRING(_3, "", ZEPHIR_TEMP_PARAM_COPY);
	ZEPHIR_CALL_FUNCTION(&_19, "preg_replace", &_8, 5, _18, _3, uri);
	zephir_check_temp_parameter(_3);
	zephir_check_call_status();
	...
	if (zephir_is_true(_20)) {
		...
		ZEPHIR_CALL_FUNCTION(&module, "array_shift", &_21, 16, uri_items);
		ZEPHIR_UNREF(uri_items);
		zephir_check_call_status();
	}
	ZEPHIR_MAKE_REF(uri_items);
	ZEPHIR_CALL_FUNCTION(&controller, "array_shift", &_21, 16, uri_items);
	ZEPHIR_UNREF(uri_items);
	zephir_check_call_status();
	...
	ZEPHIR_MAKE_REF(uri_items);
	ZEPHIR_CALL_FUNCTION(&action, "array_shift", &_21, 16, uri_items);
	ZEPHIR_UNREF(uri_items);
	zephir_check_call_status();
